...
function SignUp() {
    ...
    return (
        <div className='absolute top-0 bg-green-50 h-screen w-full grid lg:grid-cols-2'>
            ...
            <div className='grid place-items-center'>
                <div className='bg-white w-[90%] h-auto md:w-[60%] lg:w-[70%] shadow-xl rounded-2xl px-4 py-8'>
                    ...
                    <div className='mt-4 flex flex-col gap-4'>
                        ...
                        <button className='text-white w-full bg-zinc-900 text-lg font-medium py-2' onClick={handleSubmit}>Get OTP</button>

                    </div>
                    <p className='text-zinc-800 text-base font-semibold text-center mt-4'>Already have an account? <Link className='text-green-900' href={'/login'}>Login here</Link></p>
                </div>
            </div>
